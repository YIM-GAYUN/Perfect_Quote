...
### 🔍 문제 인식
- 현대인들이 일상에서 느끼는 다양한 감정적 어려움
- 획일화된 조언보다는 개인의 상황에 맞는 맞춤형 위로의 필요성
- 즉시성과 접근성을 갖춘 감정 지원 서비스의 부재

### 🎯 해결 방안
- AI 기반 대화 분석을 통한 개인 맞춤형 명언 추천
- 풍부한 명언 데이터베이스를 활용한 다양성 확보
- 사용자 친화적인 웹 인터페이스를 통한 접근성 향상
...
### 🔧 데이터 처리 과정
1. **토큰 길이 필터링**: 5~42 토큰 범위로 적절한 길이의 명언 선별
2. **샘플링**: 품질 기준으로 10,000개 샘플 추출
3. **GPT-4 인사이트 추출**: 각 명언의 핵심 의미를 30-45단어로 요약
4. **벡터 임베딩 생성**: SentenceTransformer 모델을 활용한 벡터화
...
서비스를 통해 생성되는 개인화된 명언 결과물의 예시입니다:

<img width="1000" height="1640" alt="Image" src="https://github.com/user-attachments/assets/bd3e2b32-5c9c-4c51-b8a1-eeb40767e172" />
