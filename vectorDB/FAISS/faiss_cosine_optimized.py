# FAISS 인덱스 생성(코사인유사도) 및 테스트 - 최적화 버전
...
def load_resources():
    ...
    if _index is None:
        ...
        _index = faiss.read_index("./quotes_cosine_faiss.index")
...
def find_similar_quote_cosine_optimized(user_text, top_k=3):
    """최적화된 유사 명언 검색 함수"""
    # 리소스 로드 (한 번만)
...
def interactive_search():
    ...
    while True:
        ...
        try:
            find_similar_quote_cosine_optimized(user_input)
